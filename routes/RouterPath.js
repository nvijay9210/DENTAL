module.exports={
    ...
    DELETE_CLINIC_TENANT:'/addclinic/:clinic_id/:tenant_id',
    ...
    DELETE_DENTIST_TENANT:'/adddentist/:dentist_id/:tenant_id',
    ...
    DELETE_PATIENT_TENANT:'/addpatient/:patient_id/:tenant_id',
    ...
    DELETE_APPOINTMENT_TENANT:'/addappointment/:appointment_id/:tenant_id',
    ...
    DELETE_TREATMENT_TENANT:'/addtreatment/:treatment_id/:tenant_id',
    ...
    DELETE_PRESCRIPTION_TENANT:'/addprescription/:prescription_id/:tenant_id',
}
