...
router.post(
  ADD_REMINDER,
  authenticateTenantClinicGroup(["tenant", "dentist", "patient","receptionist","superuser"]),
...
router.get(
  GETALL_REMINDER_TENANT_CLINIC,
  authenticateTenantClinicGroup(["tenant", "dentist", "patient","receptionist","superuser","receptionist"]),
...
router.get(
  GETALL_NOTIFY_DENTIST,
  authenticateTenantClinicGroup(["superuser", "dentist", "patient","receptionist"]),
