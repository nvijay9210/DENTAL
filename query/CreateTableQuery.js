const createTableQuery = {
  ...
  addDentist: `CREATE TABLE IF NOT EXISTS dentist (
    ...
    dentist_code VARCHAR(15) NOT NULL,
  ...
  addReception: `CREATE TABLE IF NOT EXISTS reception (
    ...
    username VARCHAR(50) DEFAULT NULL,
    password VARBINARY(255) DEFAULT NULL,
    reception_code VARCHAR(15) NOT NULL,
    first_name VARCHAR(50) NOT NULL,
    last_name VARCHAR(50) NOT NULL,
    email VARCHAR(255) DEFAULT NULL,
    phone_number VARCHAR(15) NOT NULL,
  ...
  addSuperUser: `CREATE TABLE IF NOT EXISTS superuser (
    ...
    KEY idx_superuser_keycloak_id (keycloak_id),
    KEY fk_superuser_tenant (tenant_id),
    KEY fk_superuser_clinic (clinic_id),
    CONSTRAINT fk_superuser_clinic FOREIGN KEY (clinic_id) REFERENCES clinic (clinic_id) ON UPDATE CASCADE,
    CONSTRAINT fk_superuser_tenant FOREIGN KEY (tenant_id) REFERENCES tenant (tenant_id) ON UPDATE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;`,
