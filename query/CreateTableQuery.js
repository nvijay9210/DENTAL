const createTableQuery = {
  ...
  room_id CHAR(36) NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000' COMMENT 'UUID of assigned room',
  ...
  rescheduled_from int(11) NULL,
  cancelled_by varchar(30) NULL,
  cancellation_reason TEXT NULL,
  is_virtual tinyint(1) NULL DEFAULT 0,
  reminder_send tinyint(1) NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS reminder (
  ...
  type enum('todo','reminder') DEFAULT reminder,
  ...
  notify_before_hours int(2) DEFAULT NULL,
