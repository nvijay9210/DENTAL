...
async function addStatusTypeSubTableData() {
  ...
  const sql = `
    ...
    VALUES 
     ...
     (1, 14, 'Afghanistan', 'AFN ؋', 'ADMIN'),
(1, 14, 'Albania', 'ALL L', 'ADMIN'),
(1, 14, 'Algeria', 'DZD جد', 'ADMIN'),
(1, 14, 'Andorra', 'EUR €', 'ADMIN'),
(1, 14, 'Angola', 'AOA Kz', 'ADMIN'),
(1, 14, 'Argentina', 'ARS $', 'ADMIN'),
(1, 14, 'Armenia', 'AMD ', 'ADMIN'),
(1, 14, 'Australia', 'AUD A$', 'ADMIN'),
(1, 14, 'Austria', 'EUR €', 'ADMIN'),
(1, 14, 'Azerbaijan', 'AZN ₼', 'ADMIN'),
(1, 14, 'Bahamas', 'BSD B$', 'ADMIN'),
(1, 14, 'Bahrain', 'BHD .ب.د', 'ADMIN'),
(1, 14, 'Bangladesh', 'BDT ৳', 'ADMIN'),
(1, 14, 'Barbados', 'BBD Bds$', 'ADMIN'),
(1, 14, 'Belarus', 'BYN Br', 'ADMIN'),
(1, 14, 'Belgium', 'EUR €', 'ADMIN'),
(1, 14, 'Belize', 'BZD BZ$', 'ADMIN'),
(1, 14, 'Benin', 'XOF CFA', 'ADMIN'),
(1, 14, 'Bhutan', 'BTN Nu.', 'ADMIN'),
(1, 14, 'Bolivia', 'BOB Bs.', 'ADMIN'),
(1, 14, 'Bosnia & Herzegovina', 'BAM KM', 'ADMIN'),
(1, 14, 'Botswana', 'BWP P', 'ADMIN'),
(1, 14, 'Brazil', 'BRL R$', 'ADMIN'),
(1, 14, 'Brunei', 'BND B$', 'ADMIN'),
(1, 14, 'Bulgaria', 'BGN лв', 'ADMIN'),
(1, 14, 'Burkina Faso', 'XOF CFA', 'ADMIN'),
(1, 14, 'Burundi', 'BIF FBu', 'ADMIN'),
(1, 14, 'Cambodia', 'KHR ៛', 'ADMIN'),
(1, 14, 'Cameroon', 'XAF FCFA', 'ADMIN'),
(1, 14, 'Canada', 'CAD C$', 'ADMIN'),
(1, 14, 'Cape Verde', 'CVE $', 'ADMIN'),
(1, 14, 'Central African Republic', 'XAF FCFA', 'ADMIN'),
(1, 14, 'Chad', 'XAF FCFA', 'ADMIN'),
(1, 14, 'Chile', 'CLP $', 'ADMIN'),
(1, 14, 'China', 'CNY ¥', 'ADMIN'),
(1, 14, 'Colombia', 'COP $', 'ADMIN'),
(1, 14, 'Comoros', 'KMF CF', 'ADMIN'),
(1, 14, 'Congo (DRC)', 'CDF FC', 'ADMIN'),
(1, 14, 'Costa Rica', 'CRC ₡', 'ADMIN'),
(1, 14, 'Croatia', 'EUR €', 'ADMIN'),
(1, 14, 'Cuba', 'CUP $', 'ADMIN'),
(1, 14, 'Cyprus', 'EUR €', 'ADMIN'),
(1, 14, 'Czech Republic', 'CZK Kč', 'ADMIN'),
(1, 14, 'Denmark', 'DKK kr', 'ADMIN'),
(1, 14, 'Djibouti', 'DJF Fdj', 'ADMIN'),
(1, 14, 'Dominican Republic', 'DOP RD$', 'ADMIN'),
(1, 14, 'Ecuador', 'USD $', 'ADMIN'),
(1, 14, 'Egypt', 'EGP £', 'ADMIN'),
(1, 14, 'El Salvador', 'USD $', 'ADMIN'),
(1, 14, 'Ethiopia', 'ETB Br', 'ADMIN'),
(1, 14, 'Eurozone', 'EUR €', 'ADMIN'),
(1, 14, 'Fiji', 'FJD FJ$', 'ADMIN'),
(1, 14, 'Finland', 'EUR €', 'ADMIN'),
(1, 14, 'France', 'EUR €', 'ADMIN'),
(1, 14, 'Gabon', 'XAF FCFA', 'ADMIN'),
(1, 14, 'Gambia', 'GMD D', 'ADMIN'),
(1, 14, 'Georgia', 'GEL ₾', 'ADMIN'),
(1, 14, 'Germany', 'EUR €', 'ADMIN'),
(1, 14, 'Ghana', 'GHS ₵', 'ADMIN'),
(1, 14, 'Greece', 'EUR €', 'ADMIN'),
(1, 14, 'Guatemala', 'GTQ Q', 'ADMIN'),
(1, 14, 'Guinea', 'GNF FG', 'ADMIN'),
(1, 14, 'Honduras', 'HNL L', 'ADMIN'),
(1, 14, 'Hong Kong', 'HKD HK$', 'ADMIN'),
(1, 14, 'Hungary', 'HUF Ft', 'ADMIN'),
(1, 14, 'Iceland', 'ISK kr', 'ADMIN'),
(1, 14, 'India', 'INR ₹', 'ADMIN'),
(1, 14, 'Indonesia', 'IDR Rp', 'ADMIN'),
(1, 14, 'Iran', 'IRR ﷼', 'ADMIN'),
(1, 14, 'Iraq', 'IQD د.ع', 'ADMIN'),
(1, 14, 'Ireland', 'EUR €', 'ADMIN'),
(1, 14, 'Israel', 'ILS ₪', 'ADMIN'),
(1, 14, 'Italy', 'EUR €', 'ADMIN'),
(1, 14, 'Jamaica', 'JMD J$', 'ADMIN'),
(1, 14, 'Japan', 'JPY ¥', 'ADMIN'),
(1, 14, 'Jordan', 'JOD ا.د', 'ADMIN'),
(1, 14, 'Kazakhstan', 'KZT ₸', 'ADMIN'),
(1, 14, 'Kenya', 'KES KSh', 'ADMIN'),
(1, 14, 'Kuwait', 'KWD KD', 'ADMIN'),
(1, 14, 'Kyrgyzstan', 'KGS лв', 'ADMIN'),
(1, 14, 'Laos', 'LAK ₭', 'ADMIN'),
(1, 14, 'Latvia', 'EUR €', 'ADMIN'),
(1, 14, 'Lebanon', 'LBP ل.ل', 'ADMIN'),
(1, 14, 'Lesotho', 'LSL L', 'ADMIN'),
(1, 14, 'Liberia', 'LRD L$', 'ADMIN'),
(1, 14, 'Libya', 'LYD د.ل', 'ADMIN'),
(1, 14, 'Liechtenstein', 'CHF CHF', 'ADMIN'),
(1, 14, 'Lithuania', 'EUR €', 'ADMIN'),
(1, 14, 'Luxembourg', 'EUR €', 'ADMIN'),
(1, 14, 'Madagascar', 'MGA Ar', 'ADMIN'),
(1, 14, 'Malawi', 'MWK MK', 'ADMIN'),
(1, 14, 'Malaysia', 'MYR RM', 'ADMIN'),
(1, 14, 'Maldives', 'MVR Rf', 'ADMIN'),
(1, 14, 'Mali', 'XOF CFA', 'ADMIN'),
(1, 14, 'Malta', 'EUR €', 'ADMIN'),
(1, 14, 'Mauritania', 'MRU UM', 'ADMIN'),
(1, 14, 'Mauritius', 'MUR ₨', 'ADMIN'),
(1, 14, 'Mexico', 'MXN $', 'ADMIN'),
(1, 14, 'Moldova', 'MDL L', 'ADMIN'),
(1, 14, 'Monaco', 'EUR €', 'ADMIN'),
(1, 14, 'Mongolia', 'MNT ₮', 'ADMIN'),
(1, 14, 'Montenegro', 'EUR €', 'ADMIN'),
(1, 14, 'Morocco', 'MAD MAD', 'ADMIN'),
(1, 14, 'Mozambique', 'MZN MT', 'ADMIN'),
(1, 14, 'Myanmar', 'MMK Ks', 'ADMIN'),
(1, 14, 'Namibia', 'NAD N$', 'ADMIN'),
(1, 14, 'Nepal', 'NPR ₨', 'ADMIN'),
(1, 14, 'Netherlands', 'EUR €', 'ADMIN'),
(1, 14, 'New Zealand', 'NZD NZ$', 'ADMIN'),
(1, 14, 'Nicaragua', 'NIO C$', 'ADMIN'),
(1, 14, 'Niger', 'XOF CFA', 'ADMIN'),
(1, 14, 'Nigeria', 'NGN ₦', 'ADMIN'),
(1, 14, 'North Korea', 'KPW ₩', 'ADMIN'),
(1, 14, 'North Macedonia', 'MKD ден', 'ADMIN'),
(1, 14, 'Norway', 'NOK kr', 'ADMIN'),
(1, 14, 'Oman', 'OMR ع.ر.', 'ADMIN'),
(1, 14, 'Pakistan', 'PKR ₨', 'ADMIN'),
(1, 14, 'Palestine', 'ILS ₪', 'ADMIN'),
(1, 14, 'Panama', 'PAB B/.', 'ADMIN'),
(1, 14, 'Papua New Guinea', 'PGK K', 'ADMIN'),
(1, 14, 'Paraguay', 'PYG ₲', 'ADMIN'),
(1, 14, 'Peru', 'PEN S/', 'ADMIN'),
(1, 14, 'Philippines', 'PHP ₱', 'ADMIN'),
(1, 14, 'Poland', 'PLN zł', 'ADMIN'),
(1, 14, 'Portugal', 'EUR €', 'ADMIN'),
(1, 14, 'Qatar', 'QAR ق.ر', 'ADMIN'),
(1, 14, 'Romania', 'RON lei', 'ADMIN'),
(1, 14, 'Russia', 'RUB ₽', 'ADMIN'),
(1, 14, 'Rwanda', 'RWF FRw', 'ADMIN'),
(1, 14, 'Saudi Arabia', 'SAR SAR', 'ADMIN'),
(1, 14, 'Senegal', 'XOF CFA', 'ADMIN'),
(1, 14, 'Serbia', 'RSD дин.', 'ADMIN'),
(1, 14, 'Seychelles', 'SCR ₨', 'ADMIN'),
(1, 14, 'Singapore', 'SGD S$', 'ADMIN'),
(1, 14, 'Slovakia', 'EUR €', 'ADMIN'),
(1, 14, 'Slovenia', 'EUR €', 'ADMIN'),
(1, 14, 'Solomon Islands', 'SBD SI$', 'ADMIN'),
(1, 14, 'South Africa', 'ZAR R', 'ADMIN'),
(1, 14, 'South Korea', 'KRW ₩', 'ADMIN'),
(1, 14, 'Spain', 'EUR €', 'ADMIN'),
(1, 14, 'Sri Lanka', 'LKR Rs', 'ADMIN'),
(1, 14, 'Sudan', 'SDG س.ج.', 'ADMIN'),
(1, 14, 'Sweden', 'SEK kr', 'ADMIN'),
(1, 14, 'Switzerland', 'CHF CHF', 'ADMIN'),
(1, 14, 'Syria', 'SYP £S', 'ADMIN'),
(1, 14, 'Taiwan', 'TWD NT$', 'ADMIN'),
(1, 14, 'Tanzania', 'TZS TSh', 'ADMIN'),
(1, 14, 'Thailand', 'THB ฿', 'ADMIN'),
(1, 14, 'Togo', 'XOF CFA', 'ADMIN'),
(1, 14, 'Tonga', 'TOP T$', 'ADMIN'),
(1, 14, 'Trinidad & Tobago', 'TTD TT$', 'ADMIN'),
(1, 14, 'Tunisia', 'TND ت.د', 'ADMIN'),
(1, 14, 'Turkey', 'TRY ₺', 'ADMIN'),
(1, 14, 'Turkmenistan', 'TMT T', 'ADMIN'),
(1, 14, 'Uganda', 'UGX USh', 'ADMIN'),
(1, 14, 'Ukraine', 'UAH ₴', 'ADMIN'),
(1, 14, 'United Arab Emirates', 'AED AED', 'ADMIN'),
(1, 14, 'United Kingdom', 'GBP £', 'ADMIN'),
(1, 14, 'United States', 'USD $', 'ADMIN'),
(1, 14, 'Uruguay', 'UYU $U', 'ADMIN'),
(1, 14, 'Uzbekistan', 'UZS лв', 'ADMIN'),
(1, 14, 'Vanuatu', 'VUV VT', 'ADMIN'),
(1, 14, 'Vatican City', 'EUR €', 'ADMIN'),
(1, 14, 'Venezuela', 'VES Bs', 'ADMIN'),
(1, 14, 'Vietnam', 'VND ₫', 'ADMIN'),
(1, 14, 'Yemen', 'YER ﷼', 'ADMIN'),
(1, 14, 'Zambia', 'ZMW ZK', 'ADMIN'),
(1, 14, 'Zimbabwe', 'ZWL Z$', 'ADMIN')`
